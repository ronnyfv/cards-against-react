...
export class Round {
  ...
  getStack(stackOrStackId) {
    return _.isObject(stackOrStackId) ? stackOrStackId : this.getStackById(stackOrStackId);
  }
  ...
  hasPlayerPlayed(playerOrPlayerId) {
    const playerId = _.isObject(playerOrPlayerId) ? playerOrPlayerId.id : playerOrPlayerId;
