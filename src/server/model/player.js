...
export class Player extends RoomBase {
  get view() {
    return {
      ...
      stack: (this.game.round && this.stack) ? this.game.round.getStackDetails(this.stack, true) : null
    };
  }
  ...
  dispose() {
    ...
    this.game.application.dispatcher.emit(A.playerDisposed(this.game.id, this.id));
  }
}
